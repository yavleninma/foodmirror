...
const I18N = {
  ru: {
    ...
    navHistory: 'История',
    navProfile: 'Профиль',
    homeEyebrow: 'Быстрый сценарий',
    homeTitle: 'Добавь фото еды и сразу получи понятный черновик.',
    homeCopy: 'Без длинных форм и лишних объяснений. Фото, проверка, сохранение.',
    homeBridge: 'Если фото пришло из бота, готовый черновик откроется здесь автоматически.',
    shootPhoto: 'Снять фото',
    uploadPhoto: 'Загрузить фото',
    targetDate: 'Дата записи',
    today: 'Сегодня',
    summary: 'Сводка дня',
    recentTitle: 'Недавние записи',
    recentCopy: 'Последние приемы пищи с быстрым повтором и правкой.',
    recentEmpty: 'Пока пусто. Начни с первого фото.',
    historyTitle: 'История',
    historyCopy: 'Выбери день и быстро посмотри, что уже было сохранено.',
    historyDayTitle: 'Записи за выбранный день',
    historyDayCopy: 'Меняй день сверху и работай с записями без лишних переходов.',
    profileTitle: 'Профиль',
    profileCopy: 'Вес, статистика и настройки без шума на главном экране.',
    accountTitle: 'Аккаунт',
    accountCopy: 'Главный вход идет через Telegram, но внутри продукт остается самостоятельным.',
    preferencesTitle: 'Настройки',
    weightTitle: 'Вес тела',
    weightCopy: 'Записывается отдельно от еды и доступен для любой даты.',
    stats: 'Статистика',
    cal: 'Ккал',
    protein: 'Белки',
    fat: 'Жиры',
    ...
    repeat: 'Повторить',
    remove: 'Удалить',
    quick: 'Быстрые правки',
    noMeals: 'За этот день пока нет записей.',
    noWeights: 'Записей веса пока нет.',
    noHistory: 'История появится после первых сохранений.',
    loading: 'Собираю данные...',
    analyzing: 'Смотрю фото и собираю черновик...',
    saved: 'Сохранено',
    deleted: 'Удалено',
    fallback: 'AI пока не подключен, поэтому это аккуратная базовая оценка.',
    avg7: 'Среднее ккал за 7 дней',
    avgProtein: 'Средний белок',
    loggedDays: 'Дней с записями',
    lastUpdate: 'Последнее обновление',
    question: 'Нужно уточнить',
    close: 'Закрыть',
    sourceTelegram: 'из Telegram',
    sourceWeb: 'из приложения',
    sourceRepeat: 'повтор из истории',
    draftReady: 'Черновик готов',
    openTelegramHelp: 'Если ты в обычном браузере, открой бота и нажми /start. Он даст безопасную ссылку входа.',
    guideTitle: 'Как это работает',
    guideStep1: 'Сними или загрузи фото',
    guideStep2: 'Проверь черновик',
    guideStep3: 'Сохрани запись',
    guideDismiss: 'Понятно',
    resumeDraft: 'Вернуться к черновику',
    resumeDraftCopy: 'Есть несохраненный черновик. Его можно быстро открыть и закончить.',
    viewAllHistory: 'Открыть историю',
    openProfile: 'Вес и настройки',
    accountViaTelegram: 'Вход через Telegram',
    accountViaWeb: 'Локальный web-вход',
    draftEditTitle: 'Проверь черновик',
    draftEditSaved: 'Правка записи',
